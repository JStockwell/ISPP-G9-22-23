...
def run():
    ...
    user1 = User.objects.create_user(username='paciente1', email='mail1@mail.com', first_name='Juan', last_name='Fernández')
    ...
    user2 = User.objects.create_user(username='paciente2', email='mail2@mail.com', first_name='Roberto', last_name='Pérez')
    ...
    user3 = User.objects.create_user(username='paciente3', email='mail3@mail.com', first_name='Enrique', last_name='Ramírez')
    ...
    user4 = User.objects.create_user(username='paciente4', email='mail4@mail.com', first_name='Julián', last_name='Alejándrez')
    ...
    user5 = User.objects.create_user(username='medico1', email='mail5@mail.com', first_name='Antonio', last_name='Smith')
