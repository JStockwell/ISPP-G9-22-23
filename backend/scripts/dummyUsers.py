...
def run():
    ...
    user1 = User.objects.create_user(username='paciente1', email='mail1@mail.com', first_name='Juan', last_name='Shareall')
    user1.set_password('paciente1')
    ...
    user2 = User.objects.create_user(username='paciente2', email='mail2@mail.com', first_name='Roberto', last_name='Sharesome')
    user2.set_password('paciente2')
    ...
    user3 = User.objects.create_user(username='paciente3', email='mail3@mail.com', first_name='Enrique', last_name='Sharenone')
    user3.set_password('paciente3')
    patient3 = Patient.objects.create(user=user3, tel='123456777', birthdate='2000-01-03', premium_account=True)
    patient3.save()

    user4 = User.objects.create_user(username='paciente4', email='mail4@mail.com', first_name='Julián', last_name='Placeholder')
    user4.set_password('paciente4')
    ...
    user5 = User.objects.create_user(username='medico1', email='mail5@mail.com', first_name='Antonio', last_name='Placeholder')
    user5.set_password('medico1')
